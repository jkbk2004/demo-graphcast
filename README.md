# An example prediction.py to fetch prediction with GraphCast_small - ERA5 1979-2015 - resolution 1.0 degree
## GraphCast prediction process: Data preparation and main driver level steps required to fetch predictions.
